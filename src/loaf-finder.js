(function () {
    ...
    const keysToIgnoreInReports = ['originalEntry', 'longTasks', 'scripts', 'loafs'];
    ...
    function observeAndProcessEntries() {
        initPerformanceObserver(processLoafEntry, "long-animation-frame");
        initPerformanceObserver((entry) => {
    ...
    function processGroupSummary(script, summaryGroup) {
        ...
        summaryGroup[sourceURL].isInNumberOfLongTasks += 1;
    }
    ...
    function initPerformanceObserver(callback, type) {
        new PerformanceObserver(function (observedLoafEntriesList) {
